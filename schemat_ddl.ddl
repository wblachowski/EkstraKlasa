...
ALTER TABLE matches_teams ADD CONSTRAINT matches_teams_pk PRIMARY KEY ( team_id,
match_id );
...
CREATE TABLE team (
    id             INTEGER NOT NULL,
    name           CLOB NOT NULL,
    founded_date   CLOB NOT NULL,
    logo_path      CLOB NOT NULL,
    stadium_id     INTEGER NOT NULL
);
...
ALTER TABLE matches_teams
    ADD CONSTRAINT matches_teams_match_fk FOREIGN KEY ( match_id )
        REFERENCES match ( id );

ALTER TABLE matches_teams
    ADD CONSTRAINT matches_teams_team_fk FOREIGN KEY ( team_id )
        REFERENCES team ( id );
